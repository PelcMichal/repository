...
public class Hello {
	...
	*/
	...
	public String saySoucetHTML(@QueryParam("cislo1")int cislo1,@QueryParam("cislo2")int cislo2)
	{
		...
		sb.append(emf.createEntityManager().createNativeQuery("select * from alien").getResultList().isEmpty());
		Alien a = (Alien)emf.createEntityManager().createNativeQuery("select * from alien").getResultList().get(0);
